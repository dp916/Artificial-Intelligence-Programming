...
#define Criteria     0.03   // all training outputs must be within this for training to stop
#define TestCriteria 0.3     // all testing outputs must be within this for generalization

#define LearningRate 0.28     // most books suggest 0.3 as a starting point
#define Momentum     0.5    // must be >=0 and <1
#define bias        -1      // output value of bias node (usually 1, sometimes -1 for sigmoid)
#define weightInit   .02    // weights are initialized randomly with this max magnitude
...
// network topology ----------------------------------------------
#define NumNodes1    3       // col 1 - must equal NumINs+1 (extra node is bias node)
#define NumNodes2    50      // col 2 - hidden layer 1, etc.
#define NumNodes3    3       // output layer is last non-zero layer, and must equal NumOUTs
...
#define NumOfRows    50      // largest layer - i.e., max number of rows in the network

// data files -----------------------------------------------
#define TrainFile    "testbeamA.dat"  // file containing training data
#define TestFile     "testbeamB.dat"  // file containing testing data
#define TrainCases   50           // number of training cases
#define TestCases    20            // number of test cases
